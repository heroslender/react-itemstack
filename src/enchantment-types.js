...
const enchantments = {
  ...
  'minecraft:fire_protection': new EnchantmentType(
    'fire_protection',
    'Fire Protection'
  ),
  'minecraft:projectile_protection': new EnchantmentType(
    'projectile_protection',
    'Projectile Protection'
  ),
  'minecraft:blast_protection': new EnchantmentType(
    'blast_protection',
    'Blast Protection'
  ),
  'minecraft:feather_falling': new EnchantmentType(
    'feather_falling',
    'Feather Falling'
  ),
  'minecraft:sharpness': new EnchantmentType('sharpness', 'Sharpness'),
  'minecraft:smite': new EnchantmentType('smite', 'Smite'),
  'minecraft:bane_of_arthropods': new EnchantmentType(
    'bane_of_arthropods',
    'Bane of Arthropods'
  ),
  ...
  'minecraft:luck_of_the_sea': new EnchantmentType(
    'luck_of_the_sea',
    'Luck of the Sea'
  ),
